...
class BogotaDataConstrucciones(Base):
    ...
    # Construction data
    concodigo = Column(String(25), nullable=True, comment="Construction code identifier")
    connpisos = Column(Integer, nullable=True, comment="Number of floors in the construction")
    ...
    barmanpre = Column(String(12), nullable=True, comment="Barmanpre code linking to property")
    conmejora = Column(Integer, nullable=True, comment="Improvement code for construction")
    ...
    geometry = Column(Geometry, nullable=False, comment="Spatial geometry of the construction")

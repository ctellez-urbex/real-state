...
class BogotaDataPredios(Base):
    ...
    barmanpre = Column(String(25), nullable=True, comment="Barmanpre code - unique property identifier")
    prechip = Column(String(25), nullable=True, comment="Property CHIP (Catastral Homologation and Identification of Properties)")
    ...
    matriculainmobiliaria = Column(String(13), nullable=True, comment="Real estate registration number")

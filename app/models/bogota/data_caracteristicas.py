...
class BogotaDataCaracteristicas(Base):
    ...
    # Area measurements
    preaconst = Column(Double, nullable=True, comment="Construction area in square meters")
    preaterre = Column(Double, nullable=True, comment="Land area in square meters")
    
    # Age information
    prevetustzmin = Column(Integer, nullable=True, comment="Minimum age of the property in years")
    prevetustzmax = Column(Integer, nullable=True, comment="Maximum age of the property in years")
    ...
    connpisos = Column(Double, nullable=True, comment="Number of floors in the construction")
    ...
    formato_direccion = Column(Text, nullable=True, comment="Formatted address of the property")
    nombre_conjunto = Column(String(557), nullable=True, comment="Name of the residential complex")
    ...
    esquinero = Column(Double, nullable=True, comment="Corner property indicator (1=corner, 0=not corner)")
    viaprincipal = Column(Double, nullable=True, comment="Main road indicator (1=main road, 0=secondary)")
    lista_precuso = Column(String(51), nullable=True, comment="List of property use codes")
    lista_precdestin = Column(String(14), nullable=True, comment="List of property destination codes")

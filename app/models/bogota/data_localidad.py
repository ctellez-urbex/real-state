...
class BogotaDataLocalidad(Base):
    ...
    locaadmini = Column(String(36), nullable=True, comment="Administrative locality name")
    ...
    # Geometry
    geometry = Column(Geometry, nullable=False, comment="Spatial geometry of the locality boundary")

...
class DataListingsActivos(Base):
    ...
    tipoinmueble = Column(
        String(11), nullable=True, comment="Property type (apartment, house, etc.)"
    )
    tiponegocio = Column(
        String(8), nullable=True, comment="Business type (sale, rent, etc.)"
    )

    # Property measurements
    areaconstruida = Column(
        Double, nullable=True, comment="Built area in square meters"
    )
    ...
    valoradministracion = Column(
        Double, nullable=True, comment="Administration fee value"
    )
    ...
    # Dates
    fecha_insertado = Column(
        Text, nullable=True, comment="Date when listing was inserted"
    )
    ...
    geometry = Column(
        Geometry, nullable=True, comment="Spatial geometry of the property"
    )
